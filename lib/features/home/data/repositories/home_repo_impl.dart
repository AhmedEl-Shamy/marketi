...
class HomeRepoImpl extends HomeRepo {
  ...
  Future<Either<Failure, List<ProductEntity>>> fetchBestProducts(
    ...
    try {
      List<ProductEntity> producs =
          await homeRemoteDataSource.fetchBestProducts(limit: limit,);
  ...
  @override
  Future<Either<Failure, List<ProductEntity>>> fetchBuyAgain({int limit = 10}) async {
    try{
      List<ProductEntity> producs =
          await homeRemoteDataSource.fetchBuyAgain(limit: limit,);
      return Right(producs);
    } on DioException catch (e) {
      return Left(ServerFailure.fromDioException(exception: e));
    }
  ...
  Future<Either<Failure, List<ProductEntity>>> fetchPupularProducts(
    ...
    try {
      List<ProductEntity> producs =
          await homeRemoteDataSource.fetchPupularProducts(limit: limit,);
      return Right(producs);
    } on DioException catch (e) {
      return Left(ServerFailure.fromDioException(exception: e));
    }
